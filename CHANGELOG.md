...
- Published the approved engineering rework with synchronized 1.0.1 app, installer and release metadata.
- Fixed pinned Microsoft OpenJDK full-version/vendor/x64 validation, successful stderr version output handling and healthy JDK reuse.
- Included shared RemoteService/session fixes, ordered bounded dispatch and stale-generation rejection.
- Included the geometric Salem DPadWidget: gap-free directional ring, circular OK, shared hover/pressed geometry and one command per press.
- Preserved working emulator, setup, TV Mode, remote, text and audio behavior during publication preparation.
- Canonical downloads: Setup.exe, Portable.zip and Source.zip; no duplicate branded aliases.
- No new tests or live validation were run for this version-only publication rebuild.
- Android Emulator Extended Controls built-in D-pad remains deferred, separately from Salem Remote.

## v1.0 - 2026-06-11 (Historical Release)
...
## Engineering Rework Included in v1.0.1

- Owner confirmed publication version 1.0.1.
...
- Installer now verifies staged payloads before replacement and reports shortcut failures.
...
- The historical v1.0 release is retained. Clean-machine certification remains outstanding.
